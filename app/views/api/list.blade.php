...
@foreach($data as $key)
	<div class="message-list" id="message-list">
		<div class="message-item message-unread">
			...
			<span class="sender" title="Alex John Red Smith"> {{$key['messageSender']}} </span>
			<span class="time">{{$key['messageDate']}}</span>

			<span class="summary">
				<span class="text">
				<a href="{{ URL::route('show', array('messageId' => $key['messageId'])) }}"> {{ $key['messageSnippet'] }}</a>					
				</span>
			</span>
		</div>															
	</div>
								...
								<div class="hide message-content" id="id-message-content">
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="dist/images/gallery/thumb-4.jpg">
												<img width="36" alt="image 3" src="dist/images/gallery/thumb-3.jpg">
												<img width="36" alt="image 2" src="dist/images/gallery/thumb-2.jpg">
												<img width="36" alt="image 1" src="dist/images/gallery/thumb-1.jpg">
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
